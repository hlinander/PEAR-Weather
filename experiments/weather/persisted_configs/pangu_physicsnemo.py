...
from experiments.weather.models.pangu_physicsnemo import PanguPhysicsNemoConfig
...
def create_config(ensemble_id, epoch=500, dataset_years=10):
    ...
    train_config = TrainConfig(
        ...
        model_config=PanguPhysicsNemoConfig(nside=64, embed_dim=192 // 4),
...
if __name__ == "__main__":
    ...
    dataset_years = 10
    eid = 0
    train_run = create_config(eid, epoch=500, dataset_years=dataset_years)
