...
get_factory().register(GraphCastPhysicsNemoConfig, GraphCastPhysicsNemo)
...
def create_config(ensemble_id, epoch=500, dataset_years=10):
    ...
    train_config = TrainConfig(
        ...
        model_config=GraphCastPhysicsNemoConfig(
            nside=64, hidden_dim=200, processor_layers=12, mesh_level=4
        ),
